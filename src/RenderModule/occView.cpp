...
TubeNext::OccView::OccView(QWidget* parent )
    : QMainWindow(parent),
    myXmin(0),
    myYmin(0),
    myXmax(0),
    ...
    myRectBand(NULL)
{
    ...
    course["scale"] = QPixmap(":/Images/Images/cursor-magnify.png");
...
const Handle(AIS_InteractiveContext)& TubeNext::OccView::getContext() const
{
    return myContext;
}

const Handle(V3d_Viewer)& TubeNext::OccView::getV3dviewer() const
{
	return myViewer;
}

const Handle(V3d_View)& TubeNext::OccView::getV3dview() const
{
	return myView;
}
...
*/
QPaintEngine* TubeNext::OccView::paintEngine() const
{
    return 0;
}

void TubeNext::OccView::paintEvent( QPaintEvent* /*theEvent*/ )
{
    myView->Redraw();
}

void TubeNext::OccView::resizeEvent( QResizeEvent* /*theEvent*/ )
{
    if( !myView.IsNull() )
    {
        myView->MustBeResized();
...
void TubeNext::OccView::fitAll( void )
{
    myView->FitAll();
    myView->ZFitAll();
    myView->Redraw();
...
void TubeNext::OccView::reset( void )
{
    myView->Reset();
}

void TubeNext::OccView::pan( void )
{
    myCurrentMode = CurAction3d_DynamicPanning;
}

void TubeNext::OccView::zoom( void )
{
    myCurrentMode = CurAction3d_DynamicZooming;
}

void TubeNext::OccView::rotate( void )
{
    myCurrentMode = CurAction3d_DynamicRotation;
}

void TubeNext::OccView::mousePressEvent( QMouseEvent* theEvent )
{		
    /*鼠标左键单击*/
...
void TubeNext::OccView::mouseReleaseEvent( QMouseEvent* theEvent )
{
...
void TubeNext::OccView::mouseMoveEvent( QMouseEvent * theEvent )
{
    
    onMouseMove(theEvent, theEvent->pos());
}

void TubeNext::OccView::wheelEvent( QWheelEvent * theEvent )
{
    onMouseWheel(theEvent->buttons(), theEvent->angleDelta().y(), theEvent->position().toPoint());
}

void TubeNext::OccView::onLButtonDown( const int /*theFlags*/, const QPoint thePoint )
{
...
void TubeNext::OccView::onMButtonDown( const int /*theFlags*/, const QPoint thePoint )
{
    // Save the current mouse coordinate in min.
    myXmin = thePoint.x();
    myYmin = thePoint.y();
...
void TubeNext::OccView::onRButtonDown( const int /*theFlags*/, const QPoint thePoint )
{
	// Save the current mouse coordinate in min.
	myXmin = thePoint.x();
	myYmin = thePoint.y();
...
void TubeNext::OccView::onMouseWheel( const int /*theFlags*/, const int theDelta, const QPoint thePoint )
{
    double aFactor = 10;
...
void TubeNext::OccView::addItemInPopup( QMenu* /*theMenu*/ )
{
}

void TubeNext::OccView::popup( const int /*x*/, const int /*y*/ )
{
}

void TubeNext::OccView::onLButtonUp( const int theFlags, const QPoint thePoint )
{
...
void TubeNext::OccView::onMButtonUp( const int /*theFlags*/, const QPoint thePoint )
{
    if (thePoint.x() == myXmin && thePoint.y() == myYmin)
...
void TubeNext::OccView::onRButtonUp( const int /*theFlags*/, const QPoint thePoint )
{
    popup(thePoint.x(), thePoint.y());
}

void TubeNext::OccView::onMouseMove(QMouseEvent* event, const QPoint thePoint )
{   
...
void TubeNext::OccView::dragEvent( const int x, const int y )
{
...
void TubeNext::OccView::multiDragEvent( const int x, const int y )
{
...
void TubeNext::OccView::inputEvent( const int x, const int y )
{
    Q_UNUSED(x);
    Q_UNUSED(y);
...
void TubeNext::OccView::multiInputEvent( const int x, const int y )
{
    Q_UNUSED(x);
    Q_UNUSED(y);
...
void TubeNext::OccView::moveEvent( const int x, const int y )
{
    myContext->MoveTo(x, y, myView, Standard_True);
}

void TubeNext::OccView::multiMoveEvent( const int x, const int y )
{
    myContext->MoveTo(x, y, myView, Standard_True);
}

void TubeNext::OccView::drawRubberBand( const int minX, const int minY, const int maxX, const int maxY )
{
    QRect aRect;
...
void TubeNext::OccView::panByMiddleButton( const QPoint& thePoint )
{
...
void TubeNext::OccView::mySlot()
{
    qDebug() << "The value is:";
}

int TubeNext::OccView::View_Top()
{
    myView->SetProj(V3d_Zpos);
    return 0;
}

int TubeNext::OccView::View_Bottom()
{
    myView->SetProj(V3d_Zneg);
    return 0;
}

int TubeNext::OccView::View_Left()
{
    myView->SetProj(V3d_Xneg);
    return 0;
}

int TubeNext::OccView::View_Right()
{
    myView->SetProj(V3d_Xpos);
    return 0;
}

int TubeNext::OccView::View_Front()
{
    myView->SetProj(V3d_Yneg);
    return 0;
}

int TubeNext::OccView::View_Rear()
{
    myView->SetProj(V3d_Ypos);
    return 0;
}

int TubeNext::OccView::View_Iso()
{
