...
TubeNext::InteractiveManager::InteractiveManager(DisplayCore* par)
{
	parent = par;

}

void TubeNext::InteractiveManager::SetSelectionModel(int mode, const Handle(AIS_InteractiveObject) theObj)
/*
...
void TubeNext::InteractiveManager::SetSelectionModel(int mode)
/*
	TopAbs_VERTEX:    return 1; //选择顶点Shape或Shape的顶点
	TopAbs_EDGE:      return 2; //选择边Shape或Shape的边
	TopAbs_WIRE:      return 3; //选择环Shape或Shape的环
...
void TubeNext::InteractiveManager::SetHighlightStytle(Standard_Real color[3], int stylemode)
{
...
void TubeNext::InteractiveManager::Highlight()
{
	parent->Context->SetAutomaticHilight(TRUE);
...
void TubeNext::InteractiveManager::capturePoint()
{
...
void TubeNext::InteractiveManager::captureShape(CaptureShapeType shapeType)
{
	/*获取显示零件的轮廓线*/
...
void TubeNext::InteractiveManager::HilightCapturePoint(gp_Pnt apoint, Standard_Real distance, Standard_Real color[3])
{
...
void TubeNext::InteractiveManager::HilightCaptureShape(TopoDS_Shape shape, Standard_Real color[3])
{
...
void TubeNext::InteractiveManager::HilightCaptureCircle(TopoDS_Shape shape, Standard_Real color[3])
{
...
void TubeNext::InteractiveManager::HilightSelectedShape(TopoDS_Shape shape, Standard_Real color[3])
{
...
void TubeNext::InteractiveManager::UnHilightSelectShape()
{
	Handle(AIS_InteractiveContext)& ctx = parent->Context;
...
void TubeNext::InteractiveManager::ClearHilightObject()
{
...
void TubeNext::InteractiveManager::ClearHilightObjects()
{
	for (auto iter : hilightedShapesList)
	{
...
TopoDS_Shape TubeNext::InteractiveManager::GetMouseClicekedShape()
{
	Handle(AIS_InteractiveContext)& ctx = parent->Context;
	Handle(StdSelect_BRepOwner) owner;
...
void TubeNext::InteractiveManager::GetMouseClicekedShapes()
{
...
void TubeNext::InteractiveManager::GetMultipleEdge()
{
...
void TubeNext::InteractiveManager::UnHighlight()
{
